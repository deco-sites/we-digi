...
const VideoText = ({ text, video, cta, bgColor }: Props) => {
  return (
          ...
          <div class="max-w-[1060px] w-full z-0 pr-[10vw] lg:pr-0">
            <svg class="w-full h-auto aspect-[1061/613]" width="1061" height="613" viewBox="0 0 1061 613" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_9_381)">
                ...
                <path d="M619.113 587.743V595.961C617.302 596.302 615.451 596.472 613.587 596.472H447.387C445.536 596.472 443.686 596.302 441.861 595.961V587.743H619.1H619.113Z" stroke={`${bgColor ? '#4c4b4b' : 'white'}`} stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M430.169 594.073C430.169 594.073 437.99 594.611 441.9 595.922H619.165C619.165 595.922 624.379 594.611 629.593 594.073H1058.9C1059.05 594.073 1059.08 594.283 1058.94 594.323C1021.98 605.83 983.499 611.676 944.8 611.676H116.252C77.5538 611.676 39.0767 605.817 2.11159 594.323C1.96822 594.283 2.00732 594.073 2.1507 594.073H430.156" stroke={`${bgColor ? '#4c4b4b' : 'white'}`} stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M1059.7 587.743V594.074H633.047C628.837 594.074 624.666 594.676 620.573 595.66C620.091 595.777 619.609 595.882 619.113 595.974V587.756H1059.7V587.743Z" stroke={`${bgColor ? '#4c4b4b' : 'white'}`} stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round" />
