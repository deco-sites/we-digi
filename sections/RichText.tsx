interface Props {
    ...
    /**
     * @title Padding Top
     * @description ex: 20 = padding-top: 20px
     */
    paddingTop?: number;
    /**
     * @title Padding Bottom
     * @description ex: 20 = padding-bottom: 20px
     */
...
const RichText = ({ text, paddingBottom, paddingTop }: Props) => {
    return (
        <div
            class="lg:max-w-[80%] mx-auto px-4"
            style={{
