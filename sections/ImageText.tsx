        ...
        <div class={`flex flex-col py-4 max-[1024px]:pt-0 ${invert ? 'lg:flex-row-reverse' : 'lg:flex-row'}`} style={{backgroundColor: bgColor ?? '#08151D'}}>
            ...
            <div class="w-full flex items-center justify-center">
                <div class="lg:w-4/6 flex flex-col items-center lg:items-start">
                    <div class="max-[1024px]:p-4 lg:[&_h2]:text-5xl lg:[&_h2]:mb-8 [&_h2]:mb-4 [&_h2]:text-4xl lg:[&_h3]:text-3xl [&_h3]:text-2xl [&_h3]:font-light lg:[&_h3]:mb-6 [&_h3]:mb-3 lg:[&_p]:!text-lg [&_p]:!text-sm [&_p]:!font-light [&_ul]:list-disc [&_ul]:pl-8 lg:[&_ul_span]:!text-lg [&_ul_span]:!text-sm" dangerouslySetInnerHTML={{ __html: text }} />
                    {cta?.url &&
