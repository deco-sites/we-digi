...
export default function Chart({ title = "we.digi", tag, sideImage, background, description, cta = [
    ...
    return (<section class="flex items-center justify-center bg-custom-size" style={{ backgroundImage: `url(${background})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
